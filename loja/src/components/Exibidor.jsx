...
import SalvarCarrinho from "../function/SalvarCarrinho";
...
export default function Exibidor(props){
  ...
  <Modelo>
    <ModeloImagens>
      <img src={props.produto.imagens[0]} alt="FOto do prduto" height={ 450} />
      <img src={props.produto.imagens[1]} alt="FOto do prduto" height={ 450} />
      <img src={props.produto.imagens[2]} alt="FOto do prduto" height={ 450} />
    </ModeloImagens>
